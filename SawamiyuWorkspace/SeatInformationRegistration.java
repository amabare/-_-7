...
@WebServlet("/seat_registration")
public class SeatInfomationRegistration extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        */
        ...
        // JSPページにフォワード
        RequestDispatcher dispatcher = request.getRequestDispatcher("ui/seat_registration_confirmation.jsp");
        dispatcher.forward(request, response);
    }
}
